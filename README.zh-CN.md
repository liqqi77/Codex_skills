...
- [`project-delivery-governor`](project-delivery-governor/README.zh-CN.md)：围绕产品主线组织版本、任务分工、独立评审、用户验收和异常恢复，避免过度评审、重复验证及工具偏离主线。
...
`SKILL.md` 是 Codex 使用的正式指令入口，`README.md` 和 `README.zh-CN.md` 用于帮助人理解 Skill。
